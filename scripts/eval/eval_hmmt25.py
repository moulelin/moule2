"""
Evaluate on HMMT February 2025 (MathArena/hmmt_feb_2025).

Usage:
  python eval_hmmt25.py --model Qwen/Qwen3-1.7B --mode greedy
  python eval_hmmt25.py --model Qwen/Qwen3-8B --mode majority --n_samples 16
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate on HMMT February 2025")
